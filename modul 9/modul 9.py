...
A=simpulbiner('Sukoharjo')
B=simpulbiner('Solo')
C=simpulbiner('Semarang')
D=simpulbiner('Jakarta')
E=simpulbiner('Karawang')
F=simpulbiner('Banten')
G=simpulbiner('Ngawi')
H=simpulbiner('Sragen')
I=simpulbiner('Boyolali')
J=simpulbiner('Purwodadi')
